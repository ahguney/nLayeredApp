...
namespace Core.Utilities.Security.JWT
{
    public class JwtTokenHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user)
        {
            ...
            JwtSecurityToken jwt = CreateJwt(expirationTime, signingCredentials);
        ...
        private JwtSecurityToken CreateJwt(DateTime expirationTime, SigningCredentials signingCredentials)
        {
